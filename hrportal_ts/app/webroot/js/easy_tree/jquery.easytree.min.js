(function($) {
    ...
    var EasyTree = function(jQueryContext, options) {
        ...
        function drag(event) {
            ...
            if (isAncester(_dnd.sourceNode, _dnd.targetId)) {
                showRejectDragHelper();
                return
            }
            if (_dnd.targetId == _dnd.sourceId) {
                hideDragHelpers();
                return
            }
        ...
        function dragEnd(event) {
            ...
            if (_dnd.targetNode && _dnd.sourceNode && canDrop) {
        ...
        function buildTree(nodes) {
            ...
            var s3 = new Date;
            var uniqueId = Math.floor(Math.random() * 1e4);
        ...
        function getMinifiedJson(nodes) {
            var j = JSON.stringify ? JSON.stringify(nodes) : "Please import json2.js";
