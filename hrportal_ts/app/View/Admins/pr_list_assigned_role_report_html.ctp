        ...
        <div class="tab-fixed">
            <table style="table-layout:fixed;" width="100%" border="0" cellspacing="1" cellpadding="5" class="exp-voucher">
                <tr class="head">
                    ...
                    <th scope="row" width="10%">Employee <?php //echo $this->Paginator->sort('Employee ID', 'vc_emp_code'); ?></th>
                    <th width="35%">Employee Name<?php //echo $this->Paginator->sort('Employee Name', 'vc_emp_name'); ?></th>
                    <th width="50%"><?php echo $application_name; ?></th>
                </tr>
                <?php $zebraClass = "";?>
                ...
                <tr class="<?php echo $zebraClass= ($zebraClass=="cont")?"cont1":"cont"; ?>">
                    ...
                    <td>
                        <?php if (isset($employee['Roles']['name'])) { ?>
                            <?php echo $employee['Roles']['name']; ?>
                        <?php } else { ?>
