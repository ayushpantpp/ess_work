...
<?php $i=0; ?>    
            ...
            <h3>Temporary Amount Claim Details ( <span><?php  echo $emp_name;?> <span> </span><span><?php echo $lastname;?></span> - <span><?php echo $emp_id; ?></span></span>) </h3>      
...
if(empty($employeeSalMonDetail)) { ?>
             ...
             <?php foreach($employeeSalMonDetail as $srcdet)  {
               ...
               <tr>
                    ...
                    <td><?php if($srcdet['EmployeeSalMon']['vc_file']!= ''){?> 
