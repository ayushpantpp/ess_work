        ...
        <div class="input-boxs">
            <table  border="0" width="97%" cellspacing="10" cellpadding="0" align="center" style="margin:0px auto;">
                <tr>
                    ...
                    <th scope="row"><strong>Day :</strong>  </th>
                    <td><?php
				...
				<tr>
                    ...
                    <td>
                    <?php echo $this->Form->input('first',array('type'=>'checkbox'));?>First &nbsp;
                    <?php echo $this->Form->input('second',array('type'=>'checkbox'));?>Second &nbsp;
                    <?php echo $this->Form->input('third',array('type'=>'checkbox'));?>Third &nbsp;
                    <?php echo $this->Form->input('fourth',array('type'=>'checkbox'));?>Fourth &nbsp;
                    <?php echo $this->Form->input('fifth',array('type'=>'checkbox'));?>Fifth &nbsp;
                    </td>
                </tr>
                <tr>
...
function doChk() {
    ...
    if(appName=='') {
        jQuery("#dnameErr").html("<?php echo "Please select holiday name."; ?>");
