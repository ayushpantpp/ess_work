    ...
    <tr>
      <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="right" valign="top" bgcolor="#c0c0c0" style="font-family:Arial, Helvetica, sans-serif; font-size : 15px; color:#333; padding:8px 10px 8px 0px; border-left:solid 1px #000000; border-right:solid 1px #000000;border-bottom:solid 1px #000000; "><strong>ESI Number :</strong></td>
          ...
          <tr>
            ...
            <td align="right" valign="top" bgcolor="#c0c0c0" style="font-family:Arial, Helvetica, sans-serif; font-size : 15px; color:#333; padding:8px 10px 8px 0px; border-left:solid 1px #000000; border-right:solid 1px #000000;border-bottom:solid 1px #000000; "><strong>PAN No :</strong></td>
            <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size : 15px; color:#333; padding:8px 0px 8px 10px; border-right:solid 1px #000000;border-bottom:solid 1px #000000; ">'.$user_detail['pan_no'].'</td>
          </tr>
          <tr>
