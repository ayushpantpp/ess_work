                            ...
                            <tr>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap">
                                        <span>
                                            ...
                                            <a data-uk-modal="{target:'#modal_overflow_response'}" onclick="return viewFiles(<?php echo $ar[$i]['MailOffice']['id'];?>)" alt="View Files" title="View Files" class="uk-badge uk-badge-primary">View Files</a></span>
                                            <?php }else{
                                                echo "NA";
                                            } ?>
                                </td>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap">
                                        <?php 
                                        if($ar[$i]['MailOffice']['forward_to'] == '3'){
                                            echo "Sent to BMS";
                                        }elseif($ar[$i]['MailOffice']['forward_to'] == '4'){
                                            echo "Sent to Directorate";
                                        }elseif($ar[$i]['MailOffice']['forward_to'] == '2'){
                                        ?>
                                         <a class="uk-badge uk-badge-primary"  href="<?php echo $this->Html->url('mail_office_update/'.base64_encode($ar[$i]['MailOffice']['id']).'/bms'); ?>" onclick="return confirm('Are you sure?');">Send to BMS</a>
                                        | <a class="uk-badge uk-badge-primary"  href="<?php echo $this->Html->url('mail_office_update/'.base64_encode($ar[$i]['MailOffice']['id']).'/dir'); ?>" onclick="return confirm('Are you sure?');">Send to Directorate</a>
