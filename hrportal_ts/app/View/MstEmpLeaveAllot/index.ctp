        ...
        <div class="input-boxs">
            <table  border="0" width="97%" cellspacing="10" cellpadding="0" align="center" style="margin:0px auto;">
				<tr>
                    ...
                    <td><?php echo $this->Form->input('emp_code', array('type'=>'select','options'=>'','empty'=>'Select Employee','class' => 'round_select', 'id' => 'departmentName')); ?>
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('leave_code', array('type'=>'select','options'=>'','empty'=>'Select Employee','class' => 'round_select', 'id' => 'departmentName')); ?>
                        <div id="dCnameErr" style="color:red"></div>
                    </td>
                </tr>
				<tr>
    ...
    jQuery(document).ready(function(){
        ...
        jQuery("#delete").live('click',function() {      
            ...
            if(confirm("Are you sure you want to delete?")) {
                jQuery("#overlay").show();
                jQuery.get('<?php echo $this->webroot; ?>MstEmpLeaveAllots/delete/'+id,{},function(data) {
                    if(data) {
						jQuery("#overlay").hide();
        ...
        jQuery("#save").live('click', function() {
            ...
            if(appName=='') {
                jQuery("#dnameErr"+id).html("Enter MstEmpLeaveAllot Name.");
            ...
            if(desgCode=='') {
                jQuery("#dCodeErr"+id).html("Enter MstEmpLeaveAllot Code.");
            ...
            if(err==0) {
                ...
                var fdata={'data[MstEmpLeaveAllot][desc]':appName,'data[MstEmpLeaveAllot][desg_code]':desgCode};
				
                jQuery.post('<?php echo $this->webroot ?>MstEmpLeaveAllots/edit/'+id,fdata,function(data) {   
                    if(data) {
                        createMsg(data.msg,data.type);
                        jQuery("#overlay").hide();
...
function doChk() {
    ...
    if(appName=='') {
        jQuery("#dnameErr").html("<?php echo "Please input MstEmpLeaveAllot name."; ?>");
	  ...
	  if(desgCode=='') {
        jQuery("#dCodeErr").html("<?php echo "Please input MstEmpLeaveAllot Code."; ?>");
   ...
   if(err==0) {
        ...
        jQuery.post('<?php echo $this->webroot ?>MstEmpLeaveAllots/add/',fdata,function(data) {   
        if(data) {
...
function findDepartment(comp_code)
{
	...
	$.ajax({
		...
		url:"<?php echo $this->webroot;?>MstEmpLeaveAllots/getDepartment/"+comp_code,	
