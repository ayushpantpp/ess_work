<script>
    ...
    function getTypeForm() {
        ...
        if (audit_param != ' ') { 
            $.ajax({
                type: "POST",
                url: '<?php echo $this->webroot ?>compliance_audit/audit_form_type/' + audit_param+'/1' ,
                //data:'project_id='+val,
    ...
    <div id="page_content_inner">
        ...
        <div class="md-card">  
            <div class="md-card-content large-padding">
                <h3 class="heading_a">Enter Audit Details</h3>
                <?php echo $this->Form->create('doc', array('url' => array('controller' => 'ComplianceAudit', 'action' => 'audit_entry_save'), 'type' => 'file', 'id' => 'form_validation', 'class' => 'uk-form-stacked'));
                ?><br>
                <div class="uk-grid" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-3" >
                        <div class="parsley-row">
                            <label for="req_cat">Audit Parameter<span class="req">*</span></label>
                    ...
                    <div class="uk-width-medium-1-3" >
                        <div class="parsley-row" >
                            ...
                            <?php 
                            echo $this->form->input('entry_date', array('type' => 'text', 'label' => false,'required'=>true, 'data-uk-datepicker' => '{format:"DD-MM-YYYY",maxDate:"'.date('d-m-Y').'"}', 'class' => "md-input"));
                            ?>
