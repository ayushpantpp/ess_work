    ...
    <div id="page_content_inner" >
        ...
        <div class="md-card uk-width-medium-1-1"  id="addform"  style="<?php echo $display;?>">  
            <div class="md-card-content">
                <?php echo $this->Form->create('ComplianceAudit', array('url' => array('controller' => 'ComplianceAudit', 'action' => 'desc_audit_checklist'), 'type' => 'file', 'id' => 'form_validation', 'class' => 'uk-form-stacked padding-left-lg')); ?>
                            ...
                            for($i=0;$i<count($allrecord);$i++)
                      {
                            ...
                            <tr>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap">
                                        <a class="uk-badge uk-badge-success" id="form_open" href="<?php echo $this->Html->url('desc_audit_checklist/'.$allrecord[$i]['CADescAuditChecklist']['id']); ?>">Edit</a>
                                         |
                                         <?php if($allrecord[$i]['CADescAuditChecklist']['status'] == '0'){ ?><a class="uk-badge uk-badge-danger" id="form_open" href="<?php echo $this->Html->url('desc_audit_checklist/'.$allrecord[$i]['CADescAuditChecklist']['id'].'/1');  ?>" onclick="return confirm('Are you sure?');">Inactive</a></span>
                                         <?php }else{ ?><a class="uk-badge uk-badge-info" id="form_open" href="<?php echo $this->Html->url('desc_audit_checklist/'.$allrecord[$i]['CADescAuditChecklist']['id'].'/0');  ?>" onclick="return confirm('Are you sure?');">Active</a></span>
                                         <?php }?>
                                </td>
                            </tr>
                            <?php  $p++; }?>
