    ...
    <div id="page_content_inner">
       ...
       <div class="md-card" >
            <div class="md-card-content ">
                    ...
                    <h3 class="heading_a uk-margin-small-bottom">Employee Definition
                <?php if(!empty($EmployeeDefinition)){ ?>
                     ...
                     <?php }?>
                         <?php if($EmployeeDefinition[0]['CAEmployeeDefinition']['marital_status'] == '1'){?>
...
//                            print_r($EmployeeDefinition);die;
                            for($i=0;$i<count($EmployeeDefinition);$i++)
                      {
                            ...
                            <tr>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap"><a class="uk-badge uk-badge-success" href="<?php echo $this->Html->url('/ComplianceAudit/emp_definition_edit/' . base64_encode($EmployeeDefinition[$i]['CAEmployeeDefinition']['id'])); ?>">Edit</a> 
