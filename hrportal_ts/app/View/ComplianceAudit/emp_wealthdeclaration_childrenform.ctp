...
<div id="allform<?php echo $formID;?>"  >
    ...
    <div class="uk-grid" data-uk-grid-margin > 
                        <div class="uk-width-medium-1-4">
                                <label for="dor" class="label-fixed">Children<span class="req">*</span></label>
                                <select name="data[ComplianceAudit][declar_depend_type<?= $formID ?>]" required="required" class="md-input declar_depend_type label-fixed">
                                    ...
                                    <div class="uk-overflow-container">
                                        <table border="1" class="uk-table uk-tab-responsive"  id="TextBoxesGroup1-<?= $formID; ?>">
                                            ...
                                            <tr style="background-color: #F9F9F9;">
                                                <td class="uk-text-center uk-width-small-1-10">1<input name="data[ComplianceAudit][rowCount1-<?= $formID ;?>]" type="hidden" id="rowCount1-<?= $formID ;?>" value="1"></td>
                                                <td><textarea name="data[ComplianceAudit][desc_1_<?= $formID ;?>][]" class="uk-width-medium-1-1 desc1 textarea_expand" id="desc1_1" maxlength="2000"></textarea></td>
                                                <td><input type="text" name="data[ComplianceAudit][aprox_amt_1_<?= $formID ;?>][]" class="uk-width-medium-1-1 aprox_amt1 textarea_expand" id="aprox_amt1_1"></td>
                                            </tr>
                                        </table>
                                ...
                                <div class="uk-width-1-2"> 
                                    <div class="uk-overflow-container">
                                        <table border="1" class="uk-table uk-tab-responsive"  id="TextBoxesGroup2-<?= $formID?>">
                                            ...
                                            <tr style="background-color: #F9F9F9 ">
                                                <td class="uk-text-center uk-width-small-1-10">1<input name="data[ComplianceAudit][rowCount2-<?= $formID ;?>]" type="hidden" id="rowCount2-<?= $formID ;?>" value="1"></td>
                                                <td><textarea name="data[ComplianceAudit][desc_2_<?= $formID ;?>][]" class="uk-width-medium-1-1 desc_2 textarea_expand" id="desc_2_1" maxlength="2000"></textarea></td>
                                                <td><input type="text" name="data[ComplianceAudit][aprox_amt_2_<?= $formID ;?>][]" class="uk-width-medium-1-1 aprox_amt_2 textarea_expand" id="aprox_amt_2_1"></td>
                                            </tr>
                                        </table>
                                ...
                                <div class="uk-width-1-2"> 
                                    <div class="uk-overflow-container">
                                        <table border="1" class="uk-table uk-tab-responsive"  id="TextBoxesGroup3-<?= $formID?>">
                                            ...
                                            <tr style="background-color: #F9F9F9">
                                                <td class="uk-text-center uk-width-small-1-10">1<input name="data[ComplianceAudit][rowCount3-<?= $formID ;?>]" type="hidden" id="rowCount3-<?= $formID ;?>" value="1"></td>
                                               <td><textarea name="data[ComplianceAudit][desc_3_<?= $formID ;?>][]" class="uk-width-medium-1-1 desc_3 textarea_expand" id="desc_3_1" maxlength="2000"></textarea></td>
                                                <td><input type="text" name="data[ComplianceAudit][aprox_amt_3_<?= $formID ;?>][]" class="uk-width-medium-1-1 aprox_amt_3 textarea_expand" id="aprox_amt_3_1"></td>
                                            </tr>
                                        </table>
...
//formid--;
        $('#'+divid+' #TextBoxesGroup1-'+formid[1]+'').append('<tr style="background-color: #F9F9F9"><?php echo $this->Form->create("ComplianceAudit"); ?>' +
                ...
                '<td><textarea name="data[ComplianceAudit][desc_1_'+formid[1]+'][]" class="uk-width-medium-1-1 desc1 textarea_expand" id="desc1_'+counter<?= $formID ;?>+'" maxlength="500" required="required"></textarea></td>' +
                '<td><input  name="data[ComplianceAudit][aprox_amt_1_'+formid[1]+'][]"  type="text" class="uk-width-medium-1-1 aprox_amt1 textarea_expand" id="aprox_amt1_'+counter<?= $formID ;?>+'" required="required" ></td>' +
                '</tr>');
...
//formid--;
        ...
        $('#'+divid+' #TextBoxesGroup2-'+formid[1]+'').append('<tr style="background-color: #F9F9F9"><?php echo $this->Form->create("ComplianceAudit"); ?>' +
                ...
                '<td><textarea name="data[ComplianceAudit][desc_2_'+formid[1]+'][]" class="uk-width-medium-1-1 desc_2 textarea_expand" id="desc_2_'+counter<?= $formID ;?>+'" maxlength="500" required="required"></textarea></td>' +
                '<td><input  name="data[ComplianceAudit][aprox_amt_2_'+formid[1]+'][]"  type="text" class="uk-width-medium-1-1 aprox_amt_2 textarea_expand" id="aprox_amt_2_'+counter<?= $formID ;?>+'" required="required" ></td>' +
                '</tr>');
...
//formid--;
        ...
        $('#'+divid+' #TextBoxesGroup3-'+formid[1]+'').append('<tr style="background-color: #F9F9F9"><?php echo $this->Form->create("ComplianceAudit"); ?>' +
                ...
                '<td><textarea name="data[ComplianceAudit][desc_3_'+formid[1]+'][]" class="uk-width-medium-1-1 desc_3 textarea_expand" id="desc_3_'+counter<?= $formID ;?>+'" maxlength="500" required="required"></textarea></td>' +
                '<td><input  name="data[ComplianceAudit][aprox_amt_3_'+formid[1]+'][]"  type="text" class="uk-width-medium-1-1 aprox_amt_3 textarea_expand" id="aprox_amt_3_'+counter<?= $formID ;?>+'" required="required" ></td>' +
                '</tr>');
