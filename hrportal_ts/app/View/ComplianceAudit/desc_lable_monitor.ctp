...
<div id="page_content">
    <div id="page_heading" data-uk-sticky="{ top: 48, media: 960 }">
        <h1>Monitoring Parameter and Label</h1>
    </div>
    <div id="page_content_inner" >
        ...
        <div class="md-card uk-width-medium-1-1"  id="addform"  style="<?php echo $display;?>">  
            <div class="md-card-content">
                <?php echo $this->Form->create('ComplianceAudit', array('url' => array('controller' => 'ComplianceAudit', 'action' => 'desc_lable_monitor'), 'type' => 'file', 'id' => 'form_validation', 'class' => 'uk-form-stacked padding-left-lg')); ?>
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-2" >
                        <div class="parsley-row">
                            ...
                            <?php
                            echo $this->form->input('vp_type', array('type' => "select", 'label' => "Monitoring Parameter Type",'empty'=>'--Select--', 'options'=>$VPtype,'required' => true, 'class' => "md-input label-fixed"));
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_issues">
                        <thead>
                            <tr>
                                ...
                                <th>Monitoring Parameter Type</th>
                                <th>Description</th>
                                <th>Labels</th>
                                <th>Created On</th>
