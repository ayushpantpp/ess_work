...
<div id="page_content">
    <div id="page_heading" data-uk-sticky="{ top: 48, media: 960 }">
        <h1>Monitor and Evaluation Set Type</h1>
    </div>
    <div id="page_content_inner" >
        ...
        <div class="md-card uk-width-medium-1-1"  id="addform"  style="<?php echo $display;?>">  
            <div class="md-card-content">
                ...
                <?php echo $this->Form->create('frm', array('url' => array('controller' => 'ComplianceAudit', 'action' => 'set_monitor_param_type'), 'type' => 'file', 'id' => 'form_validation', 'class' => 'uk-form-stacked padding-left-lg')); ?>
                <h3 class="heading_a">Monitor Evaluation Type</h3>
                <?php 
        ...
        <div class="md-card" >
            <div class="md-card-content ">
                <h3 class="heading_a uk-margin-small-bottom">List of Monitoring Parameter Type
                    <?php if($Typeid == ""){ ?>
                <a  class="md-btn md-btn-primary uk-float-right" onclick="return formOpen('<?php echo $create;?>')">Create Monitoring Parameter Type</a>
                <?php }else{ ?>
                            ...
                            for($i=0;$i<count($setType);$i++)
                      {
                            ...
                            <tr>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap">
                                        <a class="uk-badge uk-badge-success" id="form_open" href="<?php echo $this->Html->url('set_monitor_param_type/'.$setType[$i]['CASetTypeAuditMonitoring']['id']); ?>">Edit</a>
                                         | 
                                         <?php if($setType[$i]['CASetTypeAuditMonitoring']['status'] == '0'){ ?>
                                         <a class="uk-badge uk-badge-danger" id="form_open" href="<?php echo $this->Html->url('set_monitor_param_type/'.$setType[$i]['CASetTypeAuditMonitoring']['id'].'/1');  ?>" onclick="return confirm('Are you sure?');">Inactive</a></span>
                                         <?php }else{ ?><a class="uk-badge uk-badge-info" id="form_open" href="<?php echo $this->Html->url('set_monitor_param_type/'.$setType[$i]['CASetTypeAuditMonitoring']['id'].'/0');  ?>" onclick="return confirm('Are you sure?');">Active</a></span>
                                         <?php }?>
                                    </td>
                            </tr>
                            <?php  $p++; }?>
