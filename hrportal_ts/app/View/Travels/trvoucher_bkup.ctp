...
<?php echo $this->Form->input('Voucher.Place_visit', array('label' => "Places to Visit *", 'type' => 'text', 'class' => 'md-input', 'onkeypress' => "changetext()")); ?>
                            </div>
                        </div>
                        <div class="uk-width-medium-1-2">                                
                            <div class="parsley-row">
                                    <?php echo $this->Form->input('Voucher.Emp_department', array('label' => "Department*", 'type' => 'text', 'class' => 'md-input', 'value' => $dept_code, "readonly" => "readonly")); ?>
<?php echo $this->Form->input('Voucher.Emp_department', array('type' => 'hidden', 'value' => $dept_code)); ?>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-3">                                
                            <div class="parsley-row">
<?php echo $this->Form->input('Voucher.Tour_start_date', array('label' => "Tour Start Date", 'type' => 'text', 'class' => 'md-input', 'readonly' => true)); ?>
                            </div>
                        </div>

                        <div class="uk-width-medium-1-3">
                            <div class="parsley-row">
<?php echo $this->Form->input('Voucher.Going_by', array('type' => 'select', 'label' => "By*", 'empty' => 'Select', 'options' => $Going_by, 'class' => 'md-input', "data-md-selectize")); ?>
                            </div>                                
                        </div>
                        <div class="uk-width-medium-1-3">
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-3">
                            <div class="parsley-row">
                                    <?php echo $this->Form->input('Voucher.Tour_end_date', array('label' => "Tour End Date *", 'type' => 'text', "data-uk-datepicker" => "{format:'DD-MM-YYYY'}", 'class' => 'md-input', 'readonly' => true, onChange => 'return calcDate()')); ?>
                            </div>
                        </div>

                        <div class="uk-width-medium-1-3">                                
                            <div class="parsley-row">
                                    <?php echo $this->Form->input('Voucher.Coming_by', array('type' => 'select', 'label' => "By *", 'empty' => 'Select', 'options' => $Coming_by, 'class' => 'md-input' ,"data-md-selectize")); ?>
                            </div>
                        </div>
                        <div class="uk-width-medium-1-3">
                            <div class="uk-form-row parsley-row">
...
<?php echo $this->Form->input('Voucher.Booked_amt', array('label' => false, 'type' => 'text', 'class' => 'md-input', 'onKeyup' => 'calTotal()', 'MAXLENGTH' => '9', 'value' => '0')); ?>
                                ...
                                <div class="uk-width-medium-1-3">
                                    ...
                                    <div class="parsley-row">
<?php echo $this->Form->textarea('Voucher.detail_local_conceyence', array('class' => 'md-input')); ?>
                                    </div>
                                </div>
...
<?php } else { ?>
                                ...
                                <div class="parsley-row">
                                    <select id="daily_days" name="data[Voucher][days]" class ="md-input"  value="0" onKeyup="tot_allow()"  onChange="tot_allow()"  onBlur="return calcDate()"></select>
                                </div>
                                <div class="parsley-row">
                                    Days @   
                                </div>
...
<?php } ?>
                            ...
                            <div class="uk-grid" data-uk-grid-margin>
                                 <div class="uk-width-medium-1-3">  
                                    ...
                                    <div class="parsley-row">
<?php echo $this->Form->input('Voucher.Hotel_stay_expense', array('label' => false, 'type' => 'text', 'class' => 'round md-input', 'onKeyup' => 'calTotal()', 'MAXLENGTH' => '9', 'value' => '0')); ?>
                                    </div>
                                </div>
                                <div class="uk-width-medium-1-3">
...
<?php echo $this->Form->input('Voucher.Total_expense_incurred', array('label' => "", 'type' => 'text', 'class' => 'md-input', 'readonly' => 'readonly', 'onKeyup' => 'calTotal()', 'MAXLENGTH' => '9')); ?>
                                    </div>
                                </div>
                                 <div class="uk-width-medium-1-3">                            
                                    <div class="parsley-row">
