        ...
        <div class="md-card"> 
            <div class="md-card-toolbar">
                            ...
                            <h3 class="md-card-toolbar-heading-text">
                                Employee Travels Report 
                            </h3>
                        </div>
        
            <div class="md-card-content large-padding">
                <?php
                echo $this->Form->create('doc', array('url' => array('controller' => 'Travels', 'action' => 'employee_travel_report'), 'type' => 'file', 'id' => 'form_validation', 'class' => 'uk-form-stacked'));
                ?>
            ...
            <div class="md-card" >
                <div class="md-card-content ">
                    ...
                    <div class="uk-overflow-container uk-margin-bottom">
                        <?php echo $this->Form->create('Travels', array('url' => array('controller' => 'Travels', 'action' => 'travel_payment_status'), 'id' => 'form_validation', 'class' => 'uk-form-stacked')); ?>
...
//                                    print_r($VoucherDetails);
                                foreach ($VoucherDetails as $rec) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="uk-text-small uk-text-muted uk-text-center"><?php echo $rec['DtTravelVoucher']['voucher_id']; ?></td>
                                        <td><span class="uk-text-small uk-text-muted uk-text-nowrap"><?php echo $this->Common->getempname($rec['DtTravelVoucher']['emp_code']); ?></span></td>
                                        <td class="uk-text-small uk-text-muted uk-text-center"><?php echo date("d/m/Y", strtotime($rec['DtTravelVoucher']['tour_start_date'])); ?></td>
                                        <td class="uk-text-small uk-text-muted uk-text-center"><?php echo date("d/m/Y", strtotime($rec['DtTravelVoucher']['tour_end_date'])); ?></td>
                                        <td class="uk-text-small uk-text-muted uk-text-center"><?php echo $rec['DtTravelVoucher']['total_expense']; ?></td>
    ...
    <?php if ($vouch_status == '5') { ?>
                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <div class="uk-width-medium-1-2">
                                    <div class="parsley-row">
                                        <a class="uk-badge uk-badge-primery" id="form_open" href="<?php echo $this->Html->url('generate_emp_travel_report_pdf/' . $from_date . '/' . $end_date . '/' . $vouch_status.'/' .$emp_group); ?>">Generate PDF</a>
                                    </div>
                                </div>
