                ...
                <div class="header">
                    <div class="login-global" style="color:#DDDDDD;">
                      ...
                      <li><b> <?php
                                ...
                                echo $uname=ucwords(strtolower($auth['User']['user_name']));
                                ?></b></li> 
                        ...
                        <ul class="dropdown">
                           <!--  <li><a href="<?php echo $this->webroot . "acls/application"; ?>">Application, Roles, Permissions</a></li>
                            ...
                            <li><a href="<?php echo $this->webroot . "acls/assignrolereport"; ?>">Assign Role Report</a></li>  -->
                             ...
                             <?php if($uname!='')
                          {
                          ?><li><a >Control</a><ul class="sub_menu">
                            <li><a href="<?php echo $this->webroot . "Configurations/accesscontrol"; ?>">Access Control</a></li>
                            <li><a href="<?php echo $this->webroot . "Configurations/usercontrol"; ?>">User Control</a></li>
                            <li><a href="<?php echo $this->webroot . "Configurations/synccontrol"; ?>">Sync Control</a></li></ul></li>
                            <li><a >Masters</a> <?php  }?>
                                <ul class="sub_menu">
                                   ...
                                   <!--  <li><a href="<?php echo $this->webroot; ?>KraMasters/addKraType">KRA Type</a></li>
                                    ...
                                    <li><a href="<?php echo $this->webroot; ?>SetupMasters/addNotificationReminderType">Notification Reminder Type</a></li>                                   <li><a href="<?php echo $this->webroot; ?>SetupMasters/addWeightageCalculationType">Weightage Calculation Type</a></li>   
                           ...
                           <li><a href="<?php echo $this->webroot; ?>TrainingMasters/configuration">Training Flash Configuration Type</a></li></ul>
                            </li> 
