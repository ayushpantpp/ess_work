...
<?php echo $this->Form->create('adp_remark_by_app', array('url' => array('controller' => 'KraMasters', 'action' => 'adp_remark_by_app'), 'type' => 'file', 'id' => 'form_validation', 'class' => 'uk-form-stacked')); ?>
<div class="md-card">
    <div class="md-card-content large-padding">
            ...
            <div class="uk-width-medium-1-1" >
                <div class="parsley-row">
                    <label for="cc_num">Reason*:</label>
                        ...
                        <?php 
                        echo $this->Form->input('app_remarks', array('label'=>false,'type' => "text",'required'=>true,  'class' => "md-input data-md-selectize"));      
        ...
        <div class="uk-grid">
            <div class="uk-width-1-1">                        
                ...
                <button type="submit" name="adp_remark_by_app" value="submit" class="md-btn md-btn-success" href="#">Reject</button>                    
            </div>
        </div>
    </div>
</div>
