<div id="page_content" role="main">
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content large-padding"> <h3>Add KRA Rating</h3>
                <?php echo $this->Form->create('KraRating', array('url' =>array('controller' => 'KraMasters', 'action' => "addKraRating"),'id'=>'form_validation','enctype' => 'multipart/form-data','class' => 'uk-form-stacked')); ?>
                ...
                <div class="uk-grid">
                    <div class="uk-width-1-1">
                        <div class="parsley-row">
                            ...
                            <?php echo $this->Form->input('comment', array('class' => 'md-input', 'type' => 'textarea', 'label' => false , "data-parsley-trigger" => "keyup", "data-parsley-maxlength" => "500", "data-parsley-validation-threshold" => "10", "data-parsley-minlength-message" => "Come on! You need to enter at least a 20 caracters long comment..")); ?>
                    ...
                    <div class="uk-width-medium-1-2">
                        <div class="parsley-row">                            
                            ...
                            <span class="icheck-inline">
                                <input type="radio" name="data[KraRating][status]" id="val_check_ski"  value="1" data-md-icheck checked="" />
                                <label for="val_check_ski" class="inline-label">Active</label>
                            </span>
                            <span class="icheck-inline">
                                <input type="radio" name="data[KraRating][status]" id="val_check_ski" value="2" data-md-icheck />
		...
		<h3 class="heading_b uk-margin-bottom uk-margin-top">KRA Rating Scale</h3>
        <div class="md-card">
            <div class="md-card-content">                    
            <?php echo $this->Form->create('KraRating', array('url' => array('controller' => 'KraRating', 'action' => 'addKraRating'), 'id' => 'form_validation', 'class' => 'uk-form-stacked')); ?>
                        ...
                        <tbody>
                            ...
                            if (isset($kraRatingList)) {
                                ...
                                for ($i = 0; $i < count($kraRatingList); $i++) {
                                    ...
                                    $ctr = (($this->params['paging']['KraRating']['page'] * $this->params['paging']['KraRating']['limit']) - $this->params['paging']['KraRating']['limit']) + $p;

                                    if ($kraRatingList[$i]['KraRating']['status'] == 1) {
                                    ...
                                    ?>
                                    <tr>                                        
                                        <td><?php echo ucfirst($kraRatingList[$i]['KraRating']['rating_scale']); ?></td>
                                        <td><?php echo $overAllAchievement;?></td>                                        
                                        <td><?php echo wordwrap(ucfirst($kraRatingList[$i]['KraRating']['comment']), 80, "<br />\n"); ?></td>
                                        <td><?php echo $kraRatingStatus; ?></td>
                                        <td> 
                                             <!-- <a href="#" data-uk-tooltip="{cls:'uk-tooltip-small',pos:'left'}" title="Click to Delete" class="uk-badge uk-badge-danger">Delete</a> -->
                                           <a href="<?php echo $this->webroot; ?>KraMasters/kraRatingDelete/<?php echo base64_encode($kraRatingList[$i]['KraRating']['id']); ?>" onClick="return confirm('are you sure you want to delete??');" title="Click to Delete" class="uk-badge uk-badge-danger">Delete</a>
                                        </td>                          
                                    </tr> 
