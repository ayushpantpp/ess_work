...
<div id="page_content" role="main">
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">  <h3>KRA Assessment Report</h3>
                <?php echo $this->Form->create('KraReport', array('url' =>array('controller' => 'KraMasters', 'action' => "kraAssessmentReport"),'id'=>'form_validation','class' => 'uk-form-stacked')); ?>               
			 ...
			 <?php				
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-1-1 uk-margin-top">                    
                        ...
                        <a href="<?php echo $this->webroot?>KraMasters/kraAssessmentReport" class="md-btn md-btn-primary"><i class="material-icons">&#xE5D5;</i> Refresh</a>
                    </div>
                </div>                            
            ...
            <div class="md-card-content">
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-2 uk-margin-bottom">
                        <a href="<?php echo $this->webroot;?>KraMasters/kraAssessmentReportFile/<?php echo base64_encode($empCode)."/".base64_encode($fYear)."/".base64_encode($companyCode)?>" class="md-btn md-btn-primary md-btn-small"><i class="material-icons md-color-amber-900">&#xE2C4;</i> File Download</a>
                            <?php 
                                if($empCode == "0"){
                                    $empCodeStr = "All";
                                }else{
                            ...
                            <tbody>
                                <?php
                                    ...
                                    for ($i = 0; $i < count($kraRecordList); $i++) {
                                        ...
                                        $empSelfScoreStatus = $this->Common->getKraTargetLevelOne($kraRecordList[$i]['KraTarget']['emp_code'],$kraRecordList[$i]['KraTarget']['financial_year']);
                                        $appSelfScoreStatus = $this->Common->getKraTargetLevelTwo($kraRecordList[$i]['KraTarget']['emp_code'],$kraRecordList[$i]['KraTarget']['financial_year']);
