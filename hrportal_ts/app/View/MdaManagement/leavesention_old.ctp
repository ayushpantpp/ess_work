...
<table width="100%" class="exp-voucher">
    ...
    <?php echo $form->Input('lstatus' , array('options'=>$arrleavemode,'default'=>$lsdetails['0']['Leave']['vc_leave_code'] ,'label'=>false, 'empty'=>false,'id'=>'lstatus')); ?>
            ...
            <span id="cl" style="display: none"><a href="#"><font color="red" onclick="setdefault()">Close</font></a></span>
...
<tr>
<td>
<img src="<?php echo $this->webroot;?>charts/leave_manager.php?lb=<?php echo $arrL;?>&dt=<?php echo $arrD;?>">
</td>
</tr>
</table>
</td>
...
<img src="<?php echo $this->webroot;?>charts/leave_manager_monthly.php">
