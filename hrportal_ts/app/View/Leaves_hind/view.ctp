            ...
            <div class="md-card-content">
                <div class="uk-overflow-container uk-margin-bottom">
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        <thead>
                            <tr>                
                                <th><?php echo __d('debug_kit', 'Sr.No'); ?></th>
                                <th><?php echo __d('debug_kit', 'Applied Date'); ?></th>
                                <th><?php echo __d('debug_kit', 'Start Date'); ?></th>
                                <th><?php echo __d('debug_kit', 'End Date'); ?></th>
                                <th><?php echo __d('debug_kit', 'Total Leave'); ?></th>
                                <th><?php echo __d('debug_kit', 'Leave Type'); ?></th>
                                <th><?php echo __d('debug_kit', 'Reason'); ?></th>
                                <th><?php echo __d('debug_kit', 'Status'); ?></th>
                                <th><?php echo __d('debug_kit', 'Comment'); ?></th>
                                <th><?php echo __d('debug_kit', 'Medical Certificate'); ?></th>
                                <th><?php echo __d('debug_kit', 'Action'); ?></th> 
                            </tr>
                        </thead>
                        <tbody>
                            <?php
