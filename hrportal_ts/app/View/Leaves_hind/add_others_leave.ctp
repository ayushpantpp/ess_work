            ...
            <div class="md-card-content large-padding">
             ...
             echo $this->Form->create('doc', array('url' =>array('controller' => 'Leaves', 'action' =>'add_others_leave'),'type' => 'file','name'=>'Form1','id'=>'form_validation','class' => 'uk-form-stacked' ,'onSubmit'=>'return CheckLeaveCount(); ')); 
                    ...
                    <div class="uk-width-medium-1-2" >
                        <div class="parsley-row">
                            <label for="req_cat">Employee Name <span class="req">*</span></label>
                               ...
                               <?php 
                               echo $this->form->input('user_name', array('label'=>false, 'type' => 'select', 'options' =>$emp_list,'class' => "md-input",'readonly'=>true,'required'=>true,'id'=>'first_name','onChange'=>'return get_leave_details(this.value)'));
                               ?>
                        </div>
                    </div>
                    <div class="uk-width-medium-1-2">
                ...
                <div class="uk-grid" data-uk-grid-margin > 
					...
					$leave_name['PAR0000298']='LWP LEAVE';
					if($v[$gender] == 'FEMALE'){
...
<script>
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                $.each(obj, function (key, value) {
                    // alert(value.LeaveConfiguration.leave_code);
    ...
    function get_leave_details(id) {
        jQuery.ajax({
            url: '<?php echo $this->webroot ?>leaves/employeeLeaveDetail/' +id + '/1',
            success: function (data) {
