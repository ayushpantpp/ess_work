<div id="page_content">
        <div id="page_content_inner">
            <?php echo $flash = $this->Session->flash(); ?> 
				...
				<h3 class="heading_b">My Profile</h3>
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            <div data-uk-dropdown="{pos:'left-top'}" class="user_heading_menu">
                                ...
                                <div class="uk-dropdown uk-dropdown-small">
                                    <ul class="uk-nav">
                                        ...
                                        <!-- <li><a href="<?php echo $this->webroot;?>users/setting">Setting</a></li> -->
                                    </ul>
                                </div>
                            </div>
                            <div class="user_heading_avatar">
                                ...
                                <img src="<?php echo $this->webroot."images/$genderImage"; ?>"  alt="User Imagess" />
                            ...
                            <div class="user_heading_content">
                                ...
                                <ul class="user_stats">
                                    <li>
                                        <h4 class="heading_c"><?php echo $profile['MyProfile']['emp_id'];?> <span class="sub-heading">Employee ID</span></h4>
                                    </li>
                                    <li>
                                        <h4 class="heading_c"><?php echo $detail['UserDetail']['user_name'];?> <span class="sub-heading">User Name</span></h4>
                                    </li>
                                    <li>
                                        <h4 class="heading_c"><?php echo $detail['UserDetail']['email'];?><span class="sub-heading">Email ID</span></h4>
                                    </li>
                                </ul>
                            </div>                            
                                                        ...
                                                        <div class="parsley-row">
                                                            <label for="masked_date">
                                                                ...
                                                                <?php if($personal_labels['4']['Labels']['type']== 'text'){
                                                                    ...
                                                                    if($profile['MyProfile']['wedding_date'] != "") { 
