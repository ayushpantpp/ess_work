...
<div id="page_content">
    <div id="page_content_inner">
        <h3 class="heading_b uk-margin-bottom">Attendance List</h3>
         <div align="right">
                           <?php $a=array(10=>'10',20=>'20',30=>'30');
                            echo $this->form->input('pagination', array('label'=>false, 'empty'=>'Select Pagination','type' => 'select', 'onchange'=>'get_paginate(this.value)', 'id' => 'paginate', 'options'=>$a)); ?></div>
...
$getlevel=$this->Common->findAppLevel('21');
...
if ($srcdet['AttendanceDetail']['status']==2&&($getlevel==2))
{
  ...
  ?>
                  ...
                  <td class="uk-badge uk-badge-success" > <?php  echo $this->Html->link('forward','forward_attendance/'.$srcdet['AttendanceDetail']['id']);?>/
