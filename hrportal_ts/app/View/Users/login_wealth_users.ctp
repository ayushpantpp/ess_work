    ...
    <?php echo $this->Form->create('UserDetail', array('url' =>array('controller' => 'users', 'action' =>'login_wealth_users'),'id'=>'loginemployee'));?>
        <?php            
        ...
        <div class="uk-margin-top">            
            ...
            <?php echo $this->Html->link("MDA Login  ", array("controller"=>"users","action"=>"login"), array("class" => "uk-float-right")); ?>

             <?php echo $this->Html->link("Register here? ||  ", array("controller"=>"users","action"=>"Registration"), array("class" => "uk-float-right")); ?>
