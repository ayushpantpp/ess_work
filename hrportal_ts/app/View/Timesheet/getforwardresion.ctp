...
?>
	...
	<table class="table-bg" width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
            <td colspan="6" class="td-height1" style="font-weight:bold;"><?php if($forwardcmnt[0][0]['vc_forward_remarks']!="") { ?><?php  echo $forwardcmnt[0][0]['vc_forward_remarks']; ?> <?php } else { ?> No Comment Found  <?php } ?></td>
        </tr>
