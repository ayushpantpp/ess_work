...
echo $this->Form->create('Kpi', array('inputDefaults' => array(
        ...
        ), 'url' => array('controller' => 'KpiMasters', 'action' => 'editKpiSave'), 'id' => 'editkpi', 'name' => 'editkpi'));
?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content"> <br />
                        ...
                        <div class="form-group col-md-6 col-sm-6 col-xs-6">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">KPI Name : <span class="required">*</span> </label>
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <?php echo $kpiName;?>
                            </div>
                        </div>
