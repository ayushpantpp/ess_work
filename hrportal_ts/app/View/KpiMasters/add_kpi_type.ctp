...
<div id="add_msg_div">
    ...
    <h2 class="demoheaders">Add KPI Type<a href="#" id="create"></a></h2>
    
    <?php echo $this->Form->create('kpiMasters', array('url' => array('controller' => 'kpiMasters', 'action' => 'addKpiType'), 'inputDefaults' => array('label' => false, 'div' => false))); ?>    
    <div class="travel-voucher">        
        <div class="input-boxs">            
            <table  border="0" width="100%" cellspacing="5" cellpadding="0" align="center" style="margin:0px auto;">
                
                <tr>                   
                    <th width="253" scope="row" scope="row"><strong>KPI Type :</strong> </th>                    
                    <td>
                        <?php 
                        
                            echo $this->Form->input('kpi_type', array(
                                'type' => 'radio',                                
                                'legend' => false,
                                'class' => 'radio-btn',
                                'options' => array(
