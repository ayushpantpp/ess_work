...
echo $this->Form->create('Kpi', array('inputDefaults' => array(
        ...
        ), 'url' => array('controller' => 'KpiMasters', 'action' => 'kpiAssignSaveInfo'), 'id' => 'addkpi', 'name' => 'addkpi'));
 ?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <?php for ($i = 0; $i <= 0; $i++) {?>
                                <tr class="even pointer" id="row_1">
                                    <td>
                                        <?php echo $this->Form->input('kpi_name.1', array('type' => 'select', 'label' => false, 'empty' => '- -Select- -', 'options' => $kpiNamelist, 'class' => 'form-control col-md-4 col-xs-12')); ?>
                                    </td>
                                    <td>
...
<script>
    ...
    function addmore() {
        ...
        $.ajax({
            ...
            data: {"rowCount": rowCount, "pt": "assignKra"},
