...
<div id="add_msg_div">
    <h2 class="demoheaders">Update Designation<a href="#" id="create"></a></h2>
    <?php
        ...
        <div class="input-boxs">
            <table  border="0" width="97%" cellspacing="10" cellpadding="0" align="center" style="margin:0px auto;">
                ...
                <tr>
                    ...
                    <th scope="row"><strong>Designation Name :</strong>  </th>
				...
				<tr>
                    ...
                    <th scope="row"><strong>Designation Code :</strong>  </th>
