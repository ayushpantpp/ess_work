                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_issues">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap"><?php echo $rec['BMReportTypeAttachFiles']['attach_file'];?></span></td>
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap">
                                        <a class="uk-badge uk-badge-success" href="<?php echo $this->Html->url('download/'.$rec['BMReportTypeAttachFiles']['id']); ?>">View</a>
                                    </span>
                                </td>
