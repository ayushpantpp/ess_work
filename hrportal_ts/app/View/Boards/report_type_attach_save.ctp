    ...
    <div id="page_content_inner">
       ...
       <div class="md-card">  
            <div class="md-card-content large-padding">
                ...
                <?php echo $this->Form->create('doc', array('url' =>array('controller' => 'Boards', 'action' =>'report_type_attach_save'),'type' => 'file','id'=>'form_validation','class' => 'uk-form-stacked' )); 
                               ?>
                    ...
                    <div class="uk-width-medium-1-2" >
                            <div class="parsley-row">
                                <label for="case_type" class="md-input label-fixed">Data Type <span class="req">*</span></label>
                                    <?php
                                    echo $this->form->input('data_type', array('label'=>false,'type' => "select",'empty'=>'-- Select --','required'=>true,'options' => $DataTypeList,'class' => "md-input",'data-md-selectize')); 
                                    ?>
                             </div>
                       </div>
                    <div class="uk-width-medium-1-2">
