                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php $leave_name['PAR0000298']='LWP LEAVE'; ?>
				<td>
                                <?php echo $this->form->input('leave_code', array('class' => "md-input", 'label'=>false,'type' => 'select' ,'options' => array_map('strtoupper', $leave_name), 'default' => $empleavedetail[0]['LeaveDetail']['leave_code'], 'id' =>'leave')); ?>
                                <?php echo $this->form->input('leave_code_show', array('style'=>'display:none','disabled'=>'disabled','class' => "md-input", 'label'=>false,'type' => 'select' ,'options' => array_map('strtoupper', $leave_name), 'default' => $empleavedetail[0]['LeaveDetail']['leave_code'], 'id' =>'leave_code_show')); ?>  </td>
                                <?php echo $this->form->input('emp_code', 
								  array('style'=>'display:none','class' => "md-input", 'label'=>false,
								  'type' => 'hidden' ,
								  'value' => $empleavedetail[0]['LeaveDetail']['emp_code'])); ?>  
