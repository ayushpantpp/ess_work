...
<div id="add_msg_div">
    <h2 class="demoheaders">Update Labels<a href="#" id="create"></a></h2>
    <?php
    echo $this->Form->create('Designations', array('url' => '#', 'name' => 'msgForm', 'inputDefaults' => array('label' => false, 'div' => false)));
   ?>
        ...
        <div class="input-boxs">
            <table  border="0" width="97%" cellspacing="10" cellpadding="0" align="center" style="margin:0px auto;">
				<tr>
					...
					?>
                    <td><?php echo $this->Form->input('comp_code', array('type'=>'select','options'=>$company,'empty'=>'Select Company Name','class' => 'round_select', 'id' => 'companyName','onChange'=>'findDepartment(this.value);')); ?>
				...
				<tr>
                    ...
                    <th scope="row"><strong>Page/Block Name :</strong>  </th>
                    <td><?php echo $this->Form->input('dept_code', array('type'=>'select','options'=>'','empty'=>'Select Department Name','class' => 'round_select', 'id' => 'departmentName')); ?>
                        <div id="dCnameErr" style="color:red"></div>
                    </td>
                </tr>
                <tr>
                   
                    <th scope="row"><strong>Label Name :</strong>  </th>
				...
				<tr>
                    ...
                    <th scope="row"><strong>Label Status: </strong>  </th>
                    <td><?php echo $this->Form->input('desg_code', array('class' => 'round_select', 'id' => 'desgCode')); ?>
    ...
    <div id="list_msg_div1">
        <h2 class="demoheaders">Designation List</h2>
    ...
    jQuery(document).ready(function(){
        ...
        jQuery("#save").live('click', function() {
            ...
            if(err==0) {
                ...
                var fdata={'data[Designations][desc]':appName,'data[Designations][desg_code]':desgCode};
        ...
        function lists() {
            ...
            jQuery("#result").html(data);
            var fdata=jQuery("#searchForm").serialize();
            jQuery.post('<?php echo $this->webroot; ?>designations/lists',
				fdata,
				function(data) {
...
function doChk() {
	...
	if(departmentName=='Select Department Name') {
