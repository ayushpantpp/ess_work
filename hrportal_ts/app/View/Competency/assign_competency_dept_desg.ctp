...
<div id="page_content" role="main">
    <div id="page_content_inner">
        ...
        <div class="md-card">
			...
			<?php
			$mgtgroupList = $this->Common->findAllGroupDesg();
                ...
                <div class="uk-grid" data-uk-grid-margin>                                  
                    <div class="uk-width-medium-1-2">
                        ...
                        <div class="parsley-row">
                            <?php if($editAssignCompetencyDeptDesg['AssignCompetencyDeptDesg']['dept_id'] == ""){ //print_r($department_list); ?>
                                <?php echo $this->form->input('dept_id', array('label' => "", 'type' => "select",'empty' => ' -- Select Department--', 'default' => $editAssignCompetencyDeptDesg['AssignCompetencyDeptDesg']['dept_id'], 'options' => $department_list, 'class' => "md-input",'id' => 'departlkment_list', 'required' => true,'onChange' => 'return getEmployee(this.value)')); ?>
                            <?php }else{?>
                        
                        <select name="data[dept_id]" required="" id="employee_id" class="md-input" data-placeholder="Select Department..." data-md-selectize = "data-md-selectize" onChange = 'return getEmployeebyDesg(this.value)'>
