...
<div id="add_msg_div">
    ...
    <?php
    echo $this->Form->create('Department', array('url' => '#', 'name' => 'msgForm', 'inputDefaults' => array('label' => false, 'div' => false)));
    ...
    jQuery(document).ready(function () {
        ...
        jQuery("#save").live('click', function () {
            ...
            if (err == 0) {
                ...
                var fdata = {'data[Department][dept_name]': appName, 'data[Department][dept_code]': deptCode};
