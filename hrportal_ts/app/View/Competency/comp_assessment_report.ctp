                            ...
                            <tbody>
                                <?php
                                    ...
                                    for ($i = 0; $i < count($compRecordList); $i++) {
                                        ...
                                        $rewSelfScoreStatus = count($this->Common->getCompetencyTargetDetailsRevComp($compRecordList[$i]['CompetencyTarget']['emp_code'],$compRecordList[$i]['CompetencyTarget']['financial_year']));
                                    ...
                                    ?>
                                        <tr>
											...
											<td><?php $deptCode = $this->Common->findDepartmentByEmpCode($compRecordList[$i]['CompetencyTarget']['emp_code']); 
