    ...
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                <?php echo $this->Form->create('Training', array('url' => array('controller' => 'training', 'action' => 'saveCloseAttendence'), 'id' => 'form_validation', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return addtype(this)', 'class' => 'uk-form-stacked')); ?>
                <?php
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            <label for="title"><b>Training Name: </b></label>
                    ...
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            ...
                            <span><?php echo $vals['TrainingScheduleCreation']['sch_end_time']; ?>
                                ...
                                <input type="hidden" name="aid" value="<?php echo base64_encode($attendence_id); ?>">
                            </span>
                        </div>
                    </div>
                </div>
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-1">
                        <div class="uk-form-row">
                            <div class="uk-grid">
                                <div class="uk-width-medium-1-1">
                                    <span class="uk-input-group-addon"><button type="submit" class="md-btn">Close Attendance</button></span>
                                </div>
                            </div>
                        </div>
                    </div>
