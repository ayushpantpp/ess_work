<div id="page_content">
    <div id="page_content_inner">
        <h3 class="heading_b uk-margin-bottom">Add Course Schedule</h3>
        <?php echo $flash = $this->Session->flash(); ?>
        <div id="alerts"></div>
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">

                <?php echo $this->Form->create('Training', array('url' => array('controller' => 'training', 'action' => 'saveCourseSchedule'), 'id' => 'form_validation', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return addtype(this)', 'class' => 'uk-form-stacked')); ?>
                        ...
                        <div class="uk-form-row">
                            <div class="uk-grid">
                                <div class="uk-width-medium-1-2">
                                    ...
                                    <input type="text" class="md-input" name="sch_start_date" id="sch_start_date" />
                                </div>
                                <div class="uk-width-medium-1-2">
                                    <label>Schedule End Date*</label>
                                    <input type="text" class="md-input" name="sch_end_date" id="sch_end_date"/>
                                </div>
                            </div>
                        </div>
                        <div class="uk-form-row">
                            <label>Contact Person</label>
                            <input type="text" class="md-input" value="" name="contact_person" id="contact_person"/>

                        </div>
                        <div class="uk-form-row">
                            <label>Contact Number</label>
                            <input type="text" class="md-input" value="" name="contact_number" id="contact_number" maxlength="10"/>
                        </div>
                        <div class="uk-form-row">
                            <label>Location</label>
                            <input type="text" class="md-input" value="" name="location" id="location"/>
                        </div>
                        <div class="uk-form-row">
                            <label>Training Mode*</label>
                            <input type="text" class="md-input" value="" name="mode" id="mode"/>
                        </div>
                        <div class="uk-form-row">
                        ...
                        <div class="uk-form-row">
                            <div class="uk-grid">
                                <div class="uk-width-medium-1-2">
                                    ...
                                    <input type="text" class="" name="sch_start_time" id="sch_start_time"/>
                                </div>
                                <div class="uk-width-medium-1-2">
                                    <label>Schedule End Time*</label>
                                    <input type="text" class="" name="sch_end_time" id="sch_end_time" />
                                </div>
                            </div>
                        </div>
                        <div class="uk-form-row">
                            <label>Contact Mail</label>
                            <input type="text" class="md-input" value="" name="contact_email" id="contact_mail"/>
                        </div>
                        <div class="uk-form-row">
                            <label>Facility</label>
                            <input type="text" class="md-input" value="" name="facility"/>
                        </div>
                        <div class="uk-form-row">
                            <label>Instructor Name*</label>
<!--                            <input type="text" class="md-input" value="" name="instructor_name" id="instructor_name"/>-->
                            <?php echo $this->Form->input('instructor_name', array('type' => 'select', 'label' => "", 'options' => $employeelist, 'class' => 'md-input', 'empty' => '--Choose--', 'id' => 'instructor_name', "data-md-selectize" => "data-md-selectize")); ?>
                        </div>
                        <div class="uk-form-row">
                            <label>Final Registeration Date*</label>
                            <input type="text" class="md-input" value="" name="final_regis_date" id="final_regis_date"/>
                        </div>
                        <div class="uk-form-row">
                            <div class="uk-grid">
                                <div class="uk-width-medium-1-2">
