          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content"> <br />
                ...
                <?php echo $this->form->create('task', array('url'=>'','method'=>'post','action'=>'taskproject','enctype' => 'multipart/form-data','inputDefaults' => array('label' => false, 'div' => false, 'error' => array('wrap' => 'span', 'class' => 'form-horizontal form-label-left'))));
                ?>
                  <?php echo $this->form->input('hd', array('type' => 'hidden', 'id'=>'hd','value'=>'0')); ?>
                   <div class="form-group col-md-6 col-sm-6 col-xs-12">
                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="last-name">Project Type: <span class="required">*</span> </label></label>
                    ...
                    <?php echo $this->form->input('pnamenew', array('label'=>false, 'type' => 'text', 'style'=>'width:310px',
                                               ...
                                               , 'onkeyup'=> "this.value=this.value.replace(/[^\w ]+$/g,'')", 'placeholder'=>'Add New Project....')); ?>
                    </div>
                  </div> 
                ...
                <div class="x_content">
                  ...
                  <div class="form-group col-md-12 col-sm-6 col-xs-6">
                    ...
                    <input type="submit" class="btn btn-success" value="Add Project" onclick= "return post1();">  
                       ...
                       <tbody>
                           ...
                           <tr>
                               ...
                               <td><a href="#popup1" class="btn btn-primary btn-xs" 
                                ...
                                <td>
                                    <a href="#popup2" class="btn btn-info btn-xs" 
