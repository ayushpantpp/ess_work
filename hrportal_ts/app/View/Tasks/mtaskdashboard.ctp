...
<?php foreach ($tabledata as $data) { ?>
                            <tr>
                                <td><?php echo $j ?></td>
                                <!--<td><?php $get_status = $this->Common->findTaskListemp($data['TaskAssign']['tid']); ?></td>-->
                                ...
                                <td><a href="" class="uk-badge uk-badge-primary" ><?php $newstatus = $data['TaskAssign']['status'];
                                        ...
                                        ?> </a></td>
                                                    <?php $get_status = $this->Common->findTaskListemp($data['TaskAssign']['tid']);?>
                                                    <?php
                                                    if ($get_status == '0') {
                                                        $per = 0;
                                                    }
    ...
    if ($data['TaskAssign']['fstatus'] == '7') {
        ...
        ?>
                                    ...
                                    <a href="taskforward/<?php echo $data['TaskAssign']['tid'] ?>"  class="uk-badge uk-badge-success"  title="Click to Task Edit.">Edit</a><?php } ?>
    <?php
    if ($data['TaskAssign']['assignby'] == $elogin) {
        ?>
                                    <a href="taskdelete/<?php echo $data['TaskAssign']['tid'] ?>"  class="uk-badge uk-badge-danger"  title="Click to Task Delete." onclick="return confirm('Are you sure?')">Delete</a>
        <?php
    }
    ?>
                                </td>
