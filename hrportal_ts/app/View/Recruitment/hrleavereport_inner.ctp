        ...
        <div class="input-boxs-timesheet" style="overflow: <?php echo $overflow; ?>;" id="display_inner_overflow">
                                ...
                                if (count($records) > 0) {
                                        ...
                                        <div id="print_div" style="width: 100%; float: left;">
                                                <div style="width: 100%;">
                                                        ...
                                                        <?php if (!$print) { ?>
                                                                <div style="vertical-align: middle; padding: 5px; width: 15%; float: right;"><a class="button" target="_blank" href="<?php echo $this->webroot; ?>leaves/printhrleavereport/<?php echo $this->data['Search']['fromdate']; ?>/<?php echo $this->data['Search']['todate']; ?>/<?php echo $this->data['Search']['status']; ?>/<?php echo $this->data['Search']['vc_emp_code']; ?>">Print</a> </div>
                <?php } ?>
                                                </div>
                ...
                <?php foreach ($records as $key => $employee): ?>
                                                                <tr class="<?php echo $zebraClass = ($zebraClass == "cont") ? "cont1" : "cont"; ?>">
                                                                        ...
                                                                        <td><?php echo $employee['b']['vc_emp_name']; ?></td>
                                                                        <td><?php echo $employee['0']['vc_emp_name']; ?></td>
                                                                        <td><?php echo date('D, d-m-Y', strtotime($employee['a']['dt_wk_date'])); ?></td>
                                                                         <td> <?php echo $VwLeavereport->datebyapplyleavestatus($employee['b']['vc_emp_code'],date('d-m-Y', strtotime($employee['a']['dt_wk_date'])));?></td>
                                                                </tr>
                                        <?php endforeach; ?>
                                                </table>
                                        </div>
