                            ...
                            <label for="department"> Employee group <span class="req">*</span></label>
                             <?php 
                              $empname1=$this->Common->getempgroup();
                                echo $this->form->input('emp_group', array('label'=>false, 'type' => 'select', 'empty'=>'Select Employee Group','readonly' => true, 'options' =>$empname1,'class' => "md-input",'id'=>'employeegrp',"data-md-selectize" => "data-md-selectize")); ?>
                        </div>
