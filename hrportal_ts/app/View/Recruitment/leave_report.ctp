        ...
        <div class="md-card">  
            <div class="md-card-toolbar">
                            ...
                            <h3 class="md-card-toolbar-heading-text">
                               <b>Employee Leave Report</b>
                            </h3>
                        </div>
            <div class="md-card-content large-padding">
                <?php
                echo $this->Form->create('doc', array('url' => array('controller' => 'Leaves', 'action' => 'leave_report'), 'type' => 'file', 'id' => 'form_validation', 'class' => 'uk-form-stacked'));
                ?>
                <h3 class="heading_a">Leave Report<?php //echo $flag;  ?></h3>
                <div class="uk-grid" data-uk-grid-margin>

                    <div class="uk-width-medium-1-2" >
                        <div class="parsley-row">
                            <label for="folder" class="md-input label-fixed">Leave Status</label>
                            <?php
...
<div class="uk-width-medium-1-2" >
        ...
        <div id="page_content_inner">
            ...
            <div class="md-card" >
                <div class="md-card-content ">
                    <h3 class="heading_a uk-margin-small-bottom">Leave Report</h3>
                                ...
                                foreach ($VoucherDetails as $rec) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="uk-text-small uk-text-muted uk-text-center"><?php echo $i; ?></td>
                                         <td><span class="uk-text-small uk-text-muted uk-text-nowrap"><?php echo $this->Common->getempname($rec['LeaveDetail']['emp_code']); ?></span></td>
                                        <td><span class="uk-text-small uk-text-muted uk-text-nowrap"><?php echo date("d/m/Y", strtotime($rec['LeaveDetail']['leave_date'])); ?></span></td>
                                        <td class="uk-text-small uk-text-muted uk-text-center"><?php echo $this->Common->findLeaveType($rec['LeaveDetail']['leave_code']); ?></td>
                                        <td class="uk-text-small uk-text-muted uk-text-center"><?php echo $this->Common->findSatus($rec['LeaveDetail']['leave_status']); ?></td>
                                    </tr>
    ...
    <?php if ($vouch_status == '9') { ?>
                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <div class="uk-width-medium-1-2">
                                    <div class="parsley-row">
                                        <a class="uk-badge uk-badge-primery" id="form_open" href="<?php echo $this->Html->url('generate_leave_report/' . $from_date . '/' . $end_date . '/' . $vouch_status. '/' . $emp_group); ?>">Generate PDF</a>
                                    </div>
                                </div>
