...
<script>
 ...
 /*   function get_paginate(val)
  ...
  window.location.href="<?php echo $this->webroot;?>holidays/locationlisting/"+val; 
                    ...
                    <div class="uk-width-medium-1-3" >
                        <div class="parsley-row">
                            <select name="data_type_id" required="true" onchange="getDataTypeForm(this.value)" class="md-input data-md-selectize">
                                <?php
                                $DateType = array('2018'=>'2018','2017'=>'2017');
                    ...
                    <div class="uk-width-medium-1-3 " >
                        <div class="parsley-row " >
                            <span class="uk-float-center"> 
                                ...
                                //$list = "<option value=''>----Year Wise Holiday List----</option>";
                                $list = "";
                                $list.="<option value='0' selected='selected'>ALL</option>";
            ...
            <div class="md-card-content">
                ...
                <div class="uk-overflow-container uk-margin-bottom" >
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_issues">
                        ...
                        <tbody>
                            <?php
//                            echo $locationlist[0]['Holiday']['location_id'];
//                            echo "<pre>";
//                            print_r($locationlist);
...

                      {
                            ...
                            <tr>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap"><?php echo $locationlist[$i]['Holiday']['holiday_name'];?></span></td>
                                <!-- <td><span class="uk-text-small uk-text-muted uk-text-nowrap">
                    <?php 
                          
                    $holidayName = $this->Common->findLocationNameByCode($locationlist[$i]['Holiday']['location_id']);
                    ...
                    ?></span></td> -->
                                <td class="uk-text-small uk-text-muted uk-text-center"><?php echo date("d/m/Y", strtotime($locationlist[$i]['Holiday']['holiday_date']));?></td>
                                <td class="uk-text-small uk-text-muted uk-text-center"><?php if($locationlist[$i]['Holiday']['op_leave']=='0'){ echo "NO"; }else{ echo "YES"; }?></td>
                            </tr>
                            <?php  
                            $p++;
