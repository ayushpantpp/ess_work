            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    ...
                    <th width="11%">Incremented Amount</th>
                    <th width="13%">Action</th>
                </tr>
                <?php $zebraClass = ""; ?>
                <?php if(count($data)==0) {?>
                    <tr class="<?php echo $zebraClass= ($zebraClass=="even-pointer")?"even-pointer":"odd-pointer"; ?>">
                ...
                <tr class="<?php echo $zebraClass= ($zebraClass=="cont")?"cont1":"cont"; ?>">
                    ...
                    <td>
                       ...
                       <ul class="edit-delete-icon">
                         ...
                         <?php if($appraisal['Appraisals']['ch_status']=='OPEN') { ?><li style="border-right:none;"><a href="<?php echo $this->webroot.'appraisal/edit/'.$appraisal['Appraisals']['id'];?>" class="btn btn-primary btn-xs" title="Edit">edit</a></li><?php } ?>
