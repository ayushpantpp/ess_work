...
echo $form->create('Empcomplaint', array(
    'url' => '/empcomplaint/prListHtml/mgr',
    'inputDefaults' => array(
        'label' => false,
        'div' => false,
        'error' => array(
    ...
    <div class="input-boxs">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="5">
            <tr>
                ...
                <td><?php echo $form->hidden('manager',array('value'=>'mgr')); echo $form->input('startdate',array('value'=>isset($this->passedArgs['startdate'])?$this->passedArgs['startdate']:''));?></td>
                ...
                <td>
                    <?php echo $form->select('stage', array('' => '--Select Stage--', 'Recorded' => 'Recorded', 'Work In Progress' => 'Work In Progress', 'User Feedback Awaited' => 'User Feedback Awaited', 'Closed' => 'Closed', 'ESS Feedback Awaited' => 'ESS Feedback Awaited', 'Forced Closure' => 'Forced Closure', 'Dropped' => 'Dropped',), (isset($this->passedArgs['stage'])?$this->passedArgs['stage']:'') ,array('empty' => false)); ?>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        jQuery.post('<?php echo $this->webroot.'empcomplaint/prListHtml/mgr';?>',{},function(data){
            ...
            buttons: { 
                ...
                "Assign": function() {
                                jQuery.post(
                                    ...
                                    function(data){
                                        $("#assign_"+data.complaintid).hide();
                                        $("#assigned_"+data.complaintid).show();
                                        $('.new-messsages').html('<div style="width:400px;margin:0 auto;text-align:center;" id="response-message">'+data.message+'</div>');
                                        $('#response-message').highlightStyle();
                                        $('#response-message').fadeIn(600).delay(10000).fadeOut(900);
