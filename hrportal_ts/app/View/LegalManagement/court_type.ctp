                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap">
                                        ...
                                        |
                                        <?php if($rec['CourtType']['status'] == '0'){?>
                                         <a class="uk-badge uk-badge-danger" id="form_open" href="<?php echo $this->Html->url('court_type/'.$rec['CourtType']['id'].'/1'); ?>" onclick="return confirm('Do you want to inactive this record ?');">Inactive</a>
                                         <?php }elseif($rec['CourtType']['status']=='1'){?>
                                         <a class="uk-badge uk-badge-primery" id="form_open" href="<?php echo $this->Html->url('court_type/'.$rec['CourtType']['id'].'/0'); ?>" onclick="return confirm('Do you want to activate this record ?');">Active</a>
                                         <?php } ?>
                                    </span></td>
                            </tr>
                            <?php  $i++; }?>
