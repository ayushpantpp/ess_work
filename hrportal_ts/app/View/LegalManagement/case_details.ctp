    ...
    <div id="page_content_inner">
       ...
       <div class="md-card" >
            <div class="md-card-content ">
                ...
                <a  class="md-btn md-btn-primary uk-float-right" href="<?php echo $this->Html->url('case_details_save/'.base64_encode($CaseReceive['CaseReceive']['id'])); ?>">Enter Case Details</a></h3>
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_issues">
                        <thead>
                            <tr>
                                ...
                                <th>Bring Up Date</th>
                                <th>Mention/Hearing Date</th>
                                <th>Ruling/ Judgment Date</th>
                                <th>Case Status</th>
                            ...
                            for($i=0;$i<count($ar);$i++)
                      {
                            ...
                            <tr>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap"><?php if($ar[$i]['CaseDetails']['mention_date']==''){ echo "NA"; }else{ echo date("d/m/Y", strtotime($ar[$i]['CaseDetails']['mention_date']));} ?></span></td>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap">
                                        <a class="uk-badge uk-badge-success" id="form_open" href="<?php echo $this->Html->url('case_details_update/'.base64_encode($ar[$i]['CaseDetails']['id'])); ?>">Edit</a>
                                        | <a class="uk-badge uk-badge-danger" id="form_open" href="<?php echo $this->Html->url('case_details_update/'.base64_encode($ar[$i]['CaseDetails']['case_receive_id']).'/'.base64_encode($ar[$i]['CaseDetails']['id']).'/del'); ?>" onclick="return confirm('Are you sure?');">Delete</a>
                                    </span>
                                </td>
                            </tr>
                            <?php  
