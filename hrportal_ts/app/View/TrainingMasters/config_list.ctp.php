...
?><!-- View -->
    <tr class="<?php echo $class; ?>" id="vw<?php echo $res['Departments']['id']; ?>">
		...
		<span id="openattendanceh<?php echo $res['TrainingConfig']['open_attendance_hour'];?>" style="width:300px; word-wrap:break-word;">
                <?php echo $this->Form->input('open_attendance_hour', array('class' => 'round_select', 'disabled' => 'true', 'label' => false, 'id' => 'openattendanceh' . $res['TrainingConfig']['open_attendance_hour'], 'value' => $res['TrainingConfig']['open_attendance_hour'])) ?></span>
		</td> 
		<td>
		<span id="openattendancem<?php echo $res['TrainingConfig']['open_attendance_min']; ?>" style="width:300px; word-wrap:break-word;">
			<?php echo $this->Form->input('open_attendance_min', array('class' => 'round_select', 'disabled' => 'true', 'label' => false, 'id' => 'openattendanceh' . $res['TrainingConfig']['open_attendance_min'], 'value' => $res['TrainingConfig']['open_attendance_min'])) ?></span>
			</td>
                        <td>
		<span id="closeattendanceh<?php echo $res['TrainingConfig']['close_attendance_hour']; ?>" style="width:300px; word-wrap:break-word;">
			<?php echo $this->Form->input('close_attendance_hour', array('class' => 'round_select', 'disabled' => 'true', 'label' => false, 'id' => 'closeattendanceh' . $res['TrainingConfig']['close_attendance_hour'], 'value' => $res['TrainingConfig']['close_attendance_hour'])) ?></span>
			</td>
                        <td>
		<span id="closeattendancem<?php echo $res['TrainingConfig']['close_attendance_min']; ?>" style="width:300px; word-wrap:break-word;">
			<?php echo $this->Form->input('close_attendance_min', array('class' => 'round_select', 'disabled' => 'true', 'label' => false, 'id' => 'closeattendanceh' . $res['TrainingConfig']['close_attendance_min'], 'value' => $res['TrainingConfig']['close_attendance_min'])) ?></span>
			</td>
		
         			
<td> <a href="javascript:void(0);" mid="<?php echo $res['TrainingConfig']['id']; ?>" id="edit">Edit</a> | 
        ...
        <tr class="<?php echo $class; ?>" id="update<?php echo $res['TrainingConfig']['id']; ?>" style="display:none;">
            ...
            <td> 
               <?php echo $this->Form->input('open_attendance_hour', array('class' => 'round_select', 'disabled' => 'true', 'label' => false, 'id' => 'openattendanceh' . $res['TrainingConfig']['open_attendance_hour'], 'value' => $res['TrainingConfig']['open_attendance_hour'])) ?>
			</td>
			 <td> 
              <?php echo $this->Form->input('open_attendance_hour', array('class' => 'round_select', 'disabled' => 'true', 'label' => false, 'id' => 'openattendanceh' . $res['TrainingConfig']['open_attendance_hour'], 'value' => $res['TrainingConfig']['open_attendance_hour'])) ?>
			</td>
            ...
            <td > <a href="javascript:void(0);" mid="<?php echo $res['TrainingConfig']['id']; ?>" id="save">Update</a>  <a href="javascript:void(0);" mid="<?php echo $res['TrainingConfig']['id']; ?>" id="cancel">Cancel</a> </td>
