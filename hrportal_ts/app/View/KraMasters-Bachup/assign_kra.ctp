<div class="right_col" role="main">
    <div class="">
        ...
        ), 'url' => array('controller' => 'KraMasters', 'action' => 'kraKpiAssignSaveInfo'), 'id' => 'addkra', 'name' => 'addkra', 'onSubmit' => 'return chkForm(this.form)'));
        ?>
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                <label for="middle-name" class="control-label col-md-4 col-sm-4 col-xs-12">Department<span class="required">*</span></label>
                            ...
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <?php foreach($kraNameLists as $val){ ?>
                                        <option value='<?php echo $val['KraMasters']['id']?>'><?php echo $val['KraMasters']['kra_name']." (".$val['KpiMasters']['weightage'].")"; ?></option>
                                    <?php } ?>
                                    </select>
                                </div>
                            </div>
