    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Assign KRA Employee List</h2>
             ...
             <?php foreach($kraValues as $kraValue)  {?>
                                <tr class="even pointer">
                                    ...
                                    <td>
                                        <a href="<?php echo $this->webroot;?>kraMasters/kradetail/<?php echo $kraValue['KraMapEmp']['myprofile_id']; ?>/" class ="btn btn-primary btn-xs"  title="Click to View.">View</a>
<!--                                        <a href="<?php echo $this->webroot;?>kraMasters/editKraDetail/<?php echo base64_encode($kraValue['KraMapEmp']['myprofile_id']);?>/" class ="btn btn-primary btn-xs"   title="Click to Edit.">Edit</a>-->
                                    </td>
                                </tr>
             <?php $i++ ;} ?>
                            </tbody>
