        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <?php echo $this->Form->create('Kra', array('inputDefaults' => array('label' => false, 'div' => false, 'error' => array('wrap' => 'span', 'class' => 'my-error-class')), 'url' => array('controller' => 'KraMasters', 'action' => 'kraForwardSaveInfo'), 'id' => 'addkra', 'name' => 'addkra')); ?>
                    <div class="x_content">
                        <div class="x_title">
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php }else{echo $this->Form->input('employee_last_step', array('type' => 'hidden', 'label' => false, 'class' => 'form-control s-form-item s-form-all', 'value' => 1));} $i = 1;?>
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                <label for="middle-name" class="control-label col-md-4 col-sm-4 col-xs-12">Comment</label>
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <?php echo $this->Form->input('kra_comments', array('class' => 'form-control', 'type' => 'textarea')); ?>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                <thead>
                                    <tr class="headings">
                                        ...
                                        if (!empty($fwemplist)) {
                                            echo "<th> Rating</th><th> Remark</th>";
                                        } else {
                                            echo "<th> Final Rating</th><th> Final Remark</th>";
                                        }
                                        ?>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    foreach ($krlist as $kraListValue) {
                                        ...
                                        <tr class="even pointer">
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $kpiVal['kpi_masters']['kpi_name']; ?></td>
