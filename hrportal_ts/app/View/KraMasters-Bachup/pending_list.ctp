            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
             ...
             <?php foreach($kraValues as $kraValue)  {?>
                                <tr class="even pointer">
                                    ...
                                    <td>
                                        <a href="<?php echo $this->webroot;?>kraMasters/kraForward/<?php echo base64_encode($kraValue['KraMapEmp']['myprofile_id']); ?>/" class ="btn btn-primary btn-xs"  title="Click to View.">View</a>
                                    </td>
                                </tr>
             <?php $i++ ;} ?>
                            </tbody>
