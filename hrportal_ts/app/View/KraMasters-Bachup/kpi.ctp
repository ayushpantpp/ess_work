...
echo $this->Form->create('Kpi', array('inputDefaults' => array(
        ...
        ), 'url' => array('controller' => 'KraMasters', 'action' => 'kpi'), 'id' => 'kpi', 'name' => 'kpi'));
?>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content"> <br />
                        <div class="form-group col-md-6 col-sm-6 col-xs-6">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12">KRA Detail :</label>
                      ...
                      <?php echo $this->Form->input('kpiName', array('class'=>'form-control col-md-7 col-xs-12','type' => 'textarea','value'=>$kpiList['KpiMasters']['kpi_name'])); ?>
                        ...
                        <div class="form-group col-md-6 col-sm-6 col-xs-6">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Weightage :</label>
                            <div class="col-md-8 col-sm-8 col-xs-12">
                      <?php echo $this->Form->input('weightage', array('class'=>'form-control col-md-7 col-xs-12','type' => 'text','value'=>$kpiList['KpiMasters']['weightage'], 'maxlength'=>'100')); ?>
                            </div>
                        </div>
                        <div class="form-group col-md-6 col-sm-6 col-xs-6">
