    ...
    <div id="page_content_inner">
        ...
        <div class="md-card-toolbar">
                            ...
                            <h3 class="md-card-toolbar-heading-text">
                              <b> Employee LTA Report</b>
                            </h3>
                        </div>
            <div class="md-card-content large-padding">
                <?php
                echo $this->Form->create('doc', array('url' => array('controller' => 'lta', 'action' => 'employee_lta_report'), 'type' => 'file', 'id' => 'form_validation', 'class' => 'uk-form-stacked'));
                ?>
                <h3 class="heading_a">LTA Report<?php //echo $flag;  ?></h3>
                <div class="uk-grid" data-uk-grid-margin>

                    <div class="uk-width-medium-1-2" >
                        <div class="parsley-row">
                            <label for="folder" class="md-input label-fixed">LTA Status</label>
                            <?php
                            echo $this->form->input('lta_status', array('label' => false, 'type' => "select", 'empty' => ' -- Select --', 'options' => $voucherStatus, 'class' => "md-input data-md-selectize"));
                            ?>
                        </div>
                    </div>
                </div> 
                ...
                <div class="uk-grid data-uk-grid-margin">
                    ...
                    <div class="uk-width-1-3 uk-margin-top  ">                            
                        <a class="md-btn md-btn-primary" href="<?php echo $this->Html->url('employee_lta_report') ?>">Reset</a>                       
                    </div>
                </div>
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="uk-text-small uk-text-muted uk-text-nowrap"><?php echo $this->Common->getempname($rec['LtaBillAmount']['emp_code']); ?></span></td>
                                <td class="uk-text-small uk-text-muted uk-text-center"><?php echo date("d/m/Y", strtotime($rec['LtaBillAmount']['jour_start_date'])); ?></td>
<td class="uk-text-small uk-text-muted uk-text-center"><?php echo date("d/m/Y", strtotime($rec['LtaBillAmount']['jour_end_date'])); ?></td>
                            </tr>
    ...
    <?php if ($vouch_status == '5') { ?>
                    <div class="uk-grid" data-uk-grid-margin style="text-align: center">
                        <div class="uk-width-medium-1">
                            <div class="parsley-row">
                                <a class="uk-badge uk-badge-primery" id="form_open" href="<?php echo $this->Html->url('generate_emp_lta_report_pdf/' . $from_date . '/' . $end_date . '/' . $vouch_status); ?>">Generate PDF</a>
                            </div>
                        </div>
