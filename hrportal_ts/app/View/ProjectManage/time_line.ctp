...
<div class="uk-width-medium-1-2" id="forfolder">
  <div class="parsley-row md-input-wrapper md-input-filled" >
    <label class="" for="first-name">Milestone <span class="required">*</span> </label>
...
<div class="uk-width-medium-1-2" id="forfolder">
  <div class="parsley-row md-input-wrapper md-input-filled" >
    <label class="" for="last-name">Sub-Milestone <span class="required">*</span> </label>
    <select id="ContractType" class="data-md-selectize label-fixed" required>
      <option value="press" selected="Fixed">Fixed</option>
      <option value="">Variable</option>
      <option value="net">Select</option>
...
<div class="uk-width-medium-1-2" id="forfolder">
  <div class="parsley-row md-input-wrapper md-input-filled" >
    <label for="middle-name" class="">Predecessor</label>
    <select id="ContractType" class="data-md-selectize label-fixed" required>
...
<div class="uk-width-medium-1-2" id="forfolder">
  <div class="parsley-row md-input-wrapper md-input-filled" >
    <label for="middle-name" class="">Delays</label>
    <input id="ProjectName" class="md-input" type="text" name="ProjectName" disabled="disabled">
  </div>
</div>
</div>
...
<div class="uk-width-medium-1-2" id="forfolder">
  <div class="parsley-row md-input-wrapper md-input-filled" >
    <label for="middle-name" class="">Planned Effort</label>
    <input id="Currencye" class="md-input" type="text" name="Currency">
  </div>
</div>
<div class="uk-width-medium-1-2" id="forfolder">
  <div class="parsley-row md-input-wrapper md-input-filled" >
    <label for="CRRDate" class="">Planned Start Date</label>
...
<div class="uk-width-medium-1-2" id="forfolder">
  <div class="parsley-row md-input-wrapper md-input-filled" >
    <label for="CRRDate" class="">Planned End Date</label>
    <input type="text" id="ExpectedDate" name="Expected Date" data-uk-datepicker = "{format:'DD-MM-YYYY',minDate:'01-01-2018'}" required class="md-input">
  </div>
</div>
<div class="uk-width-medium-1-2" id="forfolder">
  <div class="parsley-row md-input-wrapper md-input-filled" >
    <label for="Currency" class="">Planned Calendar Day</label>
    <input id="Currencye" class="md-input" type="text" name="Currency" disabled="disabled">
  </div>
</div>
</div>
...
<div class="uk-width-medium-1-2" id="forfolder">
  <div class="parsley-row md-input-wrapper md-input-filled" >
    <label for="ProjectValue" class="">Actual Effort</label>
    <input id="Currencye" class="md-input" type="text" name="Currency" disabled="disabled">
  </div>
</div>
<div class="uk-width-medium-1-2" id="forfolder">
  <div class="parsley-row md-input-wrapper md-input-filled" >
    <label class="">Actual Start Date <!--<span class="required">*</span>--> </label>
    
    <!-- <input id="birthday" class="date-picker md-input" required type="text">-->
    <input id="Currencye" class="md-input" type="text" name="Currency" disabled="disabled">
  </div>
</div>
</div>
...
<div class="uk-width-medium-1-2" id="forfolder">
<div class="parsley-row md-input-wrapper md-input-filled" >
  <label class="">Actual End Date <span class="required">*</span> </label>
  <input id="Currencye" class="md-input" type="text" name="Currency" disabled="disabled">
</div>
</div>
<div class="uk-width-medium-1-2" id="forfolder">
<div class="parsley-row md-input-wrapper md-input-filled" >
  <label class="">Actual Calendar Days <span class="required">*</span> </label>
  <input id="Currencye" class="md-input" type="text" name="Currency" disabled="disabled">
</div>
</div>
</div>
...
<div class="uk-width-medium-1-2" id="forfolder">
<div class="parsley-row md-input-wrapper md-input-filled" >
  <label class="">Additional Effort <span class="required">*</span> </label>
  <input id="Currencye" class="md-input" type="text" name="Currency" disabled="disabled">
</div>
</div>
<div class="uk-width-medium-1-2" id="forfolder">
