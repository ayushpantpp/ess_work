...
<div class="uk-width-medium-1-1" id="div2" style="display:none;">
 <h3>Risk</h3>
                ...
                <div class="uk-width-medium-1-2" id="forfolder">
                            <div class="parsley-row md-input-wrapper md-input-filled" >
                  <label class="" for="first-name">Risk Category <span class="required">*</span> </label>
                 
                    <select id="ContractType" class="data-md-selectize label-fixed" required>
                      <option value="press" selected="Active">Risk Category</option>
                      <option value="">Risk Category1</option>
                ...
                <div class="uk-width-medium-1-2" id="forfolder">
                            <div class="parsley-row md-input-wrapper md-input-filled" >
                  <label class="" for="last-name">Frequency <span class="required">*</span> </label>
                 
                     <select id="ContractType" class="data-md-selectize label-fixed" required>
                      <option value="press" selected="Active">Frequency</option>
                      <option value="">Frequency1</option>
                      <option value="net">Select</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="uk-width-medium-1-2" id="forfolder">
                            <div class="parsley-row md-input-wrapper md-input-filled" >
                  <label for="middle-name" class="">Risk Description</label>
                 
                   <select id="ContractType" class="data-md-selectize label-fixed" required>
                      <option value="press" selected="Active">Risk Description</option>
                      <option value="">Risk Description1</option>
                      <option value="net">Select</option>
                    </select>
                  </div>
                </div>
                <div class="uk-width-medium-1-2" id="forfolder">
                            <div class="parsley-row md-input-wrapper md-input-filled" >
                  <label for="middle-name" class="">Closure Date</label>                 
                   <input type="text" id="ClosureDate" name="Expected Date" data-uk-datepicker = "{format:'DD-MM-YYYY',minDate:'01-01-2018'}" required class="md-input">
                ...
                <div class="uk-width-medium-1-2" id="forfolder">
                            <div class="parsley-row md-input-wrapper md-input-filled" >
                  <label for="middle-name" class="">Responsible Group</label>
                 
                    <select id="ContractType" class="data-md-selectize label-fixed" required>
                      <option value="press" selected="Fixed">Responsible Group</option>
                      <option value="">Responsible Group1</option>
                      <option value="net">Select</option>
                    </select>
                  </div>
                </div>
                <div class="uk-width-medium-1-2" id="forfolder">
                            <div class="parsley-row md-input-wrapper md-input-filled" >
                  <label for="CRRDate" class="">Responsible Person</label>
                 
                   <select id="ContractType" class="data-md-selectize label-fixed" required>
                      <option value="press" selected="Fixed">Responsible Person</option>
                      <option value="">Responsible Person1</option>
                      <option value="net">Select</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="uk-width-medium-1-2" id="forfolder">
                            <div class="parsley-row md-input-wrapper md-input-filled" >
                  <label for="CRRDate" class="">Proposed Action</label>
                  <textarea id="ProposedAction" required class="md-input" name="message" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
                          data-parsley-validation-threshold="10"></textarea>
                             </div>
                          </div>
                <div class="uk-width-medium-1-2" id="forfolder">
                            <div class="parsley-row md-input-wrapper md-input-filled" >
                  <label for="Currency" class="">Status</label>
                 
                  <select id="ContractType" class="data-md-selectize label-fixed" required>
                      <option value="press" selected="Fixed">Pending</option>
