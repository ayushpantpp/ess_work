...
<div id="page_content">
  ...
  <h3>Project Information List</h3>
...
<div class="uk-width-medium-1-1" id="div2" style="display:none;">
  ...
  <div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-medium-1-2" id="forfolder">
      <div class="parsley-row md-input-wrapper md-input-filled" >
        <label class="" for="first-name">Client Name <span class="required">*</span> </label>
        <input type="text" id="ClientName" required class="md-input" disabled="disabled">
      </div>
    </div>
    <div class="uk-width-medium-1-2" id="forfolder">
      <div class="parsley-row md-input-wrapper md-input-filled" >
        <label class="" for="last-name">Project ID <span class="required">*</span> </label>
  ...
  <div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-medium-1-2" id="forfolder">
      <div class="parsley-row md-input-wrapper md-input-filled" >
        <label for="middle-name" class="">Status</label>
    ...
    <div class="uk-width-medium-1-2" id="forfolder">
      <div class="parsley-row md-input-wrapper md-input-filled" >
        <label for="middle-name" class="">Project Name</label>
        <input id="ProjectName" class="md-input" type="text" name="ProjectName">
      </div>
    </div>
  </div>
  <div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-medium-1-2" id="forfolder">
      <div class="parsley-row md-input-wrapper md-input-filled" >
        <label for="middle-name" class="">Contract Type</label>
        <select id="ContractType" class="data-md-selectize label-fixed" required>
    ...
    <div class="uk-width-medium-1-2" id="forfolder">
      <div class="parsley-row md-input-wrapper md-input-filled" >
        <label for="CRRDate" class="">CRR Date</label>
  ...
  <div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-medium-1-2" id="forfolder">
      <div class="parsley-row md-input-wrapper md-input-filled" >
        <label for="CRRDate" class="">PO Date</label>
        <input type="text" id="ExpectedDate" name="Expected Date" data-uk-datepicker = "{format:'DD-MM-YYYY',minDate:'01-01-2018'}" required class="md-input">
      </div>
      </div>
      <div class="uk-width-medium-1-2" id="forfolder">
  ...
  <div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-medium-1-2" id="forfolder">
    <div class="parsley-row md-input-wrapper md-input-filled" >
      <label class="">Project Value <!--<span class="required">*</span>--> </label>
      
      <!-- <input id="birthday" class="date-picker md-input" required type="text">-->
      <input type="text" class="md-input" disabled="disabled" placeholder="$909090" disabled="disabled" >
    </div>
  </div>
  </div>
  ...
  <div class="uk-grid">
    <div class="uk-width-1-3 uk-margin-top">
      ...
      <a class="md-btn md-btn-primary" href="<?php echo $this->Html->url('/users/dashboard') ?>">Cancel</a> </div>
  </div>
