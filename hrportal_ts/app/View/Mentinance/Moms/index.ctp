...
<!--        <div class="page-title">
        ...
        <div class="row" >
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <?php echo $this->form->create('mom', array('url'=>'','method'=>'post','action'=>'assign','enctype' => 'multipart/form-data','inputDefaults' => array('label' => false, 'div' => false))); ?>
<!--             <div class="form-group col-md-6 col-sm-6 col-xs-12" style="line-height:35px;">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
                      <?php echo $this->form->input('mid', array('class' => "form-control s-form-item s-form-all", 
                          'label'=>false,'value'=>$asd,'type' => 'hidden', 'id' =>'mid')); ?>
                    </div>
                  </div>-->
                  <div class="form-group col-md-6 col-sm-6 col-xs-12" style="line-height:35px;">                      
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
                      <?php echo $this->form->input('des', array('class' => "form-control s-form-item s-form-all", 
                          'label'=>false,'type' => 'text', 'id' =>'des','required'=>true, )); ?>  
                  ...
                  <div class="form-group col-md-6 col-sm-6 col-xs-12" style="line-height:35px;">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
                     <?php echo $this->form->input('date', array('label'=>false,'class'=>"form-control col-md-7 col-xs-12 ",
                                   'type' => 'text', 'id' => 'date','value'=>$dt ,'required'=>true,)); ?>
                    </div>
                  </div>
                 ...
                 <div class="form-group col-md-6 col-sm-6 col-xs-12" >
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
                      ...
                      <?php echo $this->form->input('res', array('label'=>false,'class'=>"form-control", 'type'=>"text", 'id' =>'res')); ?>
                    </div>
                  </div>
                ...
                <div class="form-group col-md-6 col-sm-6 col-xs-12" >
                  ...
                  <div class="form-group col-md-6 col-sm-6 col-xs-12" style="line-height:35px;">                      
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
                        ...
                        <?php echo $this->form->textarea('mr', array('label'=>false,'class'=>"form-control",
                          'style'=>"width: 186px; height: 100px;",'id' =>'mr','required'=>true,)); ?>
                  ...
                  <div class="form-group col-md-6 col-sm-6 col-xs-12" >
                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Message">Remark:<span class="required">(Optional)</span> </label>
                    <div class="col-md-5 col-sm-5 col-xs-12">
                    
                      <?php echo $this->form->textarea('remark', array('label'=>false,'class'=>"form-control",
                          'style'=>"width: 186px; height: 100px;",'id' =>'remark',)); ?>
                    </div>
                  </div>
