            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                  ...
                  <thead>
                    ...
                    <th class="column-title">Member Response</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                         <td> <?php echo $i+1;   ?> </td> 
                          <td> <?php echo $ar[$i]['MomAssign']['date'];   ?> </td> 
                          
                          <?php $str1= substr($ar[$i]['MomAssign']['description'], 0, 10);?>
                          
                           <td> <?php if($ar[$i]['MomAssign']['description']==""){ echo "--N/A--";} else {?>
                               <a href="#popup6" onclick="Get_Details6('<?php echo $ar[$i]['MomAssign']['mid'] ?>')" title="Click here"><?php echo $str1."..";?></a>
                           ...
                           <td>
                              ...
                              <a href="#popup2" onclick="Get_Details2('<?php echo $ar[$i]['MomAssign']['mid'] ?>')" title="Click here">Click to show</a>
                              
                          
                          </td>
                          
                          <?php $str= substr($ar[$i]['MomAssign']['responsibility'], 0, 10);?>
                          
                           <td> <?php if($ar[$i]['MomAssign']['responsibility']==""){ echo "--N/A--";} else {?>
                               <a href="#popup5" onclick="Get_Details5('<?php echo $ar[$i]['MomAssign']['mid'] ?>')" title="Click here"><?php echo $str."..";?></a>
                           ...
                           if($ar[$i]['MomAssign']['remark']==""){echo "--N/A--";}else {echo $ar[$i]['MomAssign']['remark'];}
                           ?></textarea> </td>
                           <!--<td> <?php //echo $ar[$i]['MomAssign']['createby'];   ?> </td>-->
                           <td> 
                              
                              <!--<textarea rows="1" style="height: 30px"><?php //echo $ar[$i]['MomAssign']['mremark']; ?></textarea>-->
                              <a href="#popup3" onclick="Get_Details3('<?php echo $ar[$i]['MomAssign']['mid'] ?>')" title="Click here">show Response</a>
                           ...
                           <td> 
                           <a href="#popup1"  
                                      onclick="Get_Details('<?php echo $ar[$i]['MomAssign']['mid'] ?>')"  title="Click to View.">Click Here</a>
                           </td>
                           <td> 
                               <?php  if($ar[$i]['MomAssign']['uploaded_file']!=Null){
                               echo "<a target='blank' href='".$this->webroot."uploads/mom/".$ar[$i]['MomAssign']['uploaded_file']."'>".$ar[$i]['MomAssign']['uploaded_file']."</a>"; 
                               
                               } else { echo "--N/A--";}  ?>
                           </td>
                           
                          <td>
                              <a href="momedit/<?php echo $ar[$i]['MomAssign']['mid'];?>"  title="Click to Task Edit.">Edit</a> |
                              <a href="momdelete/<?php echo $ar[$i]['MomAssign']['mid'];?>"  title="Click to Task Delete.">Delete</a>
                          </td>
...
{   //alert("MOM ID=="+id);
    jQuery.ajax({
        url: '<?php echo $this->webroot ?>moms/empresponse/'+id,
        success: function(data){
      //alert(data);
